...
### A World of Warcraft server for the WOW Expansion Cataclysm
----
*MaNGOS Three* is an open source project, built in [C++][7], it's fast, runs on multiple,
...
Cataclysm version supporting clients from the [patch 4.3.4][50] branch, specifically patch 4.3.4.

If you liked the forth incarnation of [World of Warcraft][2] and still want to play
[Cata WoW][4], you should try *MangosThree*. We provide an authentication
...
*MangosThree* with the OpenSSL project's [OpenSSL library][48] (or with modified
