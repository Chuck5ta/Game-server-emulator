...
TrainerSpellState Player::GetTrainerSpellState(TrainerSpell const* TrainerSpell, uint32 reqLevel) const
{
    if (!TrainerSpell)
    ...
    // known spell
    if (HasSpell(TrainerSpell->learnedSpell))
    ...
    bool prof = SpellMgr::IsProfessionSpell(TrainerSpell->learnedSpell);
    ...
    if (SpellChainNode const* spell_chain = sSpellMgr.GetSpellChainNode(TrainerSpell->learnedSpell))
    {
    ...
    SpellEntry const* spell = sSpellStore.LookupEntry(TrainerSpell->learnedSpell);
